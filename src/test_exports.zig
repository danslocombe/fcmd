...
test "Phase 4.5: multiple writers - semaphore stress test" {
    ...
    // Spawn 8 writer processes, each inserting 80 unique strings
    // Writer 0: writer0_0 ... writer0_79
    // Writer 1: writer1_0 ... writer1_79
    // ...
    // Writer 7: writer7_0 ... writer7_79
    const num_writers = 8;
    ...
    // Verify all 640 strings (8 writers × 80 strings) are present
